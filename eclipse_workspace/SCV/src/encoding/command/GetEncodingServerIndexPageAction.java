...
public class GetEncodingServerIndexPageAction implements RedirectPageHandler {
	
	private static final String VIEW_PAGE = "/WEB-INF/view/Encoding/index.jsp";
	
	@Override
	public String getURL() {
		return "/page/encoding/index";
	}
